      ...
      <div>
        <Tree
          ...
          render={(node, { depth, isOpen, onToggle, handleRef }) => (
            <div
              onClick={onToggle}
              className="py-2  pr-2 bg-white rounded-lg mt-4 w-52 hover:w-96 transition-all h-14 flex items-center tree_icons_parents"
            ...
            >
              ...
              {node.droppable ? (
                ...
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  class="w-5 h-5 min-w-fit text-slate-600 mx-[3px]"
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
